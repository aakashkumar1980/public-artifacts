...
def main():
    ...
    xml_posts = spark.sparkContext.newAPIHadoopFile("/user/admin/private-learningv2/stackexchange/Posts.xml", 'com.databricks.spark.xml.XmlInputFormat', 'org.apache.hadoop.io.Text', 'org.apache.hadoop.io.Text', conf={'xmlinput.start': '<row', 'xmlinput.end': '/>'})
    ...
    postDF.write.format('com.databricks.spark.csv').options(header='false').save('/user/admin/private-learningv2/stackexchange/posts_all_csv')
